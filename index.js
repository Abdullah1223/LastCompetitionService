...
if(cluster.isPrimary){
  ...
  const privateKey = fs.readFileSync('/etc/letsencrypt/live/rankmusic.zapto.org/privkey.pem', 'utf8');
const certificate = fs.readFileSync('/etc/letsencrypt/live/rankmusic.zapto.org/fullchain.pem', 'utf8');
